...
# Syndication Loan CorDapp

Welcome to the Syndication Loan CorDapp which is based on the [CorDapp tutorial](http://docs.corda.net/tutorial-cordapp.html) found on
the Corda docsite.
...
To get started, clone this repository with:
     ...
     git clone https://github.com/DAYUCS/cordapp-syndication-loan.git

Change directories to the newly cloned repo:

     cd cordapp-syndication-loan
...
**NOTE: Building the Syndication Loan CorDapp from master WILL fail without 
